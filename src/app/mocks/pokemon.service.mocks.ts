...
export const getPokemonListMockResponse = {
  count: 1281,
...
export const getPokemonListMockExpectedResponse: Pokemon[] = [
  {
    id: '1',
    name: 'bulbasaur',
    image:
...
export const getPokemonDetailsMockResponse: PokemonDetailsResponse = {
  abilities: [
    {
      ability: {
        name: 'overgrow',
...
export const mockPokemonSpeciesMockResponse = {
  evolution_chain: { url: 'https://pokeapi.co/api/v2/evolution-chain/1' },
};

export const pokemonEvolutionChainMockResponse: PokemonEvolutionChainResponse =
  {
...
export const expectedPokemonDetailsResponse: PokemonDetails = {
  name: 'bulbasaur',
  height: 7,
  weight: 69,
  image:
